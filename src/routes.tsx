...
export function Routers() {
  return (
    <Routes>
      ...
      <Route path="/service/:previousProfessionalId" element={<Service />} />
      <Route path="/day/:id" element={<Day />} />
      <Route path="/hours/:previousProfessionalId/:id" element={<Hours />} />
      ...
      <Route path="/findDay/:previousProfessionalId" element={<PrivateRoutes />}>
        <Route path="/findDay/:previousProfessionalId" element={<FindDay />} />
      </Route>

      <Route path="/findSchedule/:previousProfessionalId/:date" element={<PrivateRoutes />}>
        <Route path="/findSchedule/:previousProfessionalId/:date" element={<FindSchedule />} />
      </Route>
